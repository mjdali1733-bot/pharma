                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      _popularBrandsSection(brandController, filterController),
                      Obx(() {
      ...
      () => brandController.brandModel.value.data != null
          ? Column(
              ...
              children: [
                ...
                SizedBox(
                  height:
                      brandController.brandModel.value.data?.isEmpty ?? false
                      ? 0
                      : 170.h,
                  child: ListView.builder(
                    scrollDirection: Axis.horizontal,
                    shrinkWrap: true,
                    itemCount: brandController.brandModel.value.data?.length,
                    itemBuilder: (context, index) {
                      return InkWell(
                        borderRadius: BorderRadius.circular(16.r),
                        onTap: () {
                          filterController.addBrandId(
                            brandController.brandModel.value.data![index].id
                                .toString(),
                          );
