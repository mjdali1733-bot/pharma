...
class NavBarView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final GlobalKey cartKey = Get.put(GlobalKey(), tag: 'cartKey');
    ...
    return WillPopScope(
      ...
      child: AnnotatedRegion<SystemUiOverlayStyle>(
        ...
        child: Scaffold(
          ...
          body: Obx(() {
            final isCartPage = navController.selectedIndex.value == 2;

            return Padding(
              padding: EdgeInsets.only(bottom: isCartPage ? 0 : 82.h),
