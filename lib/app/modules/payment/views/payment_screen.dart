                      ...
                      () => OrderSummay(
                        ...
                        onTap: () async {
                          if (paymentController.paymentMethodIndex.value ==
                            ...
                            var confirmJsonData = cartController.cartItems.map((
                              e,
                            ) {
                              final quantity = e.quantity.value;
                              final price = _doubleValue(e.variationPrice);
                              final oldPrice = _doubleValue(
                                e.variationOldPrice,
                              );
                              final tax = _doubleValue(e.totalProductTax);
                              final shipping = _doubleValue(e.shippingCharge);
                              final discount = _doubleValue(
                                e.product.data?.discount,
                              );
                              final subtotal = price * quantity;

                              return {
                                "name": e.product.data?.name ?? '',
                                "product_id": e.product.data?.id ?? 0,
                                ...
                                paymentController.confirmOrder(
                                  ...
                                  couponId:
                                      couponController
                                          ...
                                          ?.toInt() ??
                                      0,
                                  orderType: widget.isDelivery == false
                                      ? 10
                                      : 5,
                                  source: 10.toInt(),
